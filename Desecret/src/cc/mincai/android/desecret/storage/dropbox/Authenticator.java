...
public class Authenticator {
     ...
     */
    @SuppressWarnings("unchecked")
    public Authenticator(Map config) throws IOException, OAuthException {
        this.config = config;
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map loadConfig(String path) throws IOException, ParseException {
        BufferedReader in = new BufferedReader(new FileReader(path), RESTUtility.BUFFER_SIZE);
        return loadConfig(in);
    }
    
    @SuppressWarnings("unchecked")
    public static Map loadConfig(InputStream is) throws IOException, ParseException {
        BufferedReader in = new BufferedReader(new InputStreamReader(is), RESTUtility.BUFFER_SIZE);
        return loadConfig(in);
    }

    @SuppressWarnings("unchecked")
    public static Map loadConfig(BufferedReader in) throws IOException, ParseException {
